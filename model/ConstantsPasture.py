...
CONTRACT_TYPES = [26,27]
RECORD_TYPES = [1, 2, 3, 4, 15, 16, 25]
FIRST_STATUS_CODE = 1
...
from EnumerationsPasture import ApplicationType
APPLICATION_TYPE_WITH_DURATION = [ApplicationType.legitimate_rights, ApplicationType.pasture_use]
