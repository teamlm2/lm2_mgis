...
from ClZoneSub import *

class PlProjectParcelZoneSub(Base):

    __tablename__ = 'pl_project_parcel_zone_sub'
    ...
    zone_sub_id = Column(Integer, ForeignKey('cl_zone_sub.zone_sub_id'))
