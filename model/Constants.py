...
CASE_PARCEL_BASE = 1
CASE_PARCEL_NEIGHBOR = 2

MULTIPLE_APPLICATIONS_NOT_ALLOWED = [2, 7, 8, 9, 10, 11, 12, 13, 14, 15]

LOG_FILE_NAME = "lm2.log"

set_search_path = "SET search_path to base, codelists, ub_data, admin_units, settings, pasture, public, data_soums_union, data_cama, data_plan, data_estimate, data_ub, data_address, sdplatform, webgis, data_landuse"
