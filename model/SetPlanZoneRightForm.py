...
class SetPlanZoneRightForm(Base):

    __tablename__ = 'set_plan_zone_right_form'

    # foreign keys:
    right_form_id = Column(Integer, ForeignKey('cl_right_form.right_form_id'), primary_key=True)
