...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="building_no">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="address_neighbourhood" index="6" name="Орон нутгийн нэршил"/>
    <alias field="address_streetname" index="5" name="Гудамжны нэр"/>
    <alias field="area_m2" index="3" name="Талбай /м2/"/>
    <alias field="building_id" index="0" name="Барилгын дугаар"/>
    <alias field="building_no" index="1" name="Барилгын хаяг"/>
    <alias field="geo_id" index="2" name="Гео код"/>
    <alias field="maintenance_case" index="9" name="Засвар код"/>
    <alias field="valid_from" index="7" name="Эхлэх хугацаа"/>
    <alias field="valid_till" index="8" name="Дуусах хугацаа"/>
  </aliases>
