...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geographic_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="gn_geo_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="landuse">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="street_side">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="57,160,51,0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="0,0,187,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="address_parcel_no"/>
    ...
    <property key="labeling/textColorB" value="187"/>
  ...
  <aliases>
    ...
    <alias field="is_active" index="2" name=""/>
    <alias field="in_source" index="3" name=""/>
    <alias field="zipcode_id" index="4" name=""/>
    <alias field="street_id" index="5" name=""/>
    <alias field="address_parcel_no" index="6" name=""/>
    <alias field="address_streetname" index="7" name=""/>
    <alias field="address_neighbourhood" index="8" name=""/>
    <alias field="geographic_name" index="9" name=""/>
    <alias field="au1" index="10" name=""/>
    <alias field="au2" index="11" name=""/>
    <alias field="au3" index="12" name=""/>
    <alias field="khoroolol_id" index="13" name=""/>
    <alias field="sort_value" index="14" name=""/>
    <alias field="created_by" index="15" name=""/>
    <alias field="updated_by" index="16" name=""/>
    <alias field="created_at" index="17" name=""/>
    <alias field="updated_at" index="18" name=""/>
    <alias field="description" index="19" name=""/>
    <alias field="status" index="20" name=""/>
    <alias field="parcel_type" index="21" name=""/>
    <alias field="valid_from" index="22" name=""/>
    <alias field="valid_till" index="23" name=""/>
    <alias field="address_au_khoroolol_id" index="24" name=""/>
    <alias field="area_m2" index="25" name=""/>
    <alias field="is_marked" index="26" name=""/>
    <alias field="is_new_address" index="27" name=""/>
    <alias field="street_code" index="28" name=""/>
    <alias field="gn_geo_id" index="29" name=""/>
    <alias field="landuse" index="30" name=""/>
    <alias field="street_side" index="31" name=""/>
    <alias field="name" index="32" name=""/>
    <alias field="code" index="33" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="79282848">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="geographic_name"/>
      ...
      <column width="-1" hidden="0" type="field" name="gn_geo_id"/>
      <column width="-1" hidden="0" type="field" name="landuse"/>
      <column width="-1" hidden="0" type="field" name="street_side"/>
