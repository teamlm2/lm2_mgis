...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="decision_date" index="5" name=""/>
    <alias field="decision_no" index="6" name=""/>
    <alias field="decision_level_id" index="7" name=""/>
    <alias field="is_active" index="8" name=""/>
    <alias field="in_source" index="9" name=""/>
    <alias field="street_type_id" index="10" name=""/>
    <alias field="valid_from" index="11" name=""/>
    <alias field="valid_till" index="12" name=""/>
    <alias field="area_m2" index="13" name=""/>
    ...
    <alias field="au1" index="20" name=""/>
    <alias field="au2" index="21" name=""/>
    <alias field="au3" index="22" name=""/>
  </aliases>
