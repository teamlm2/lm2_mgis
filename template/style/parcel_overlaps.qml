...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="203,198,204,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="address_khashaa"/>
    ...
    <property key="labeling/textColorR" value="202"/>
    <property key="labeling/textTransp" value="50"/>
  ...
  <aliases>
    <alias field="address_khashaa" index="5" name="Хашааны дугаар"/>
    <alias field="address_neighbourhood" index="7" name="Орон нутгийн нэршил"/>
    <alias field="address_streetname" index="6" name="Гудамжны нэр"/>
    <alias field="area_m2" index="3" name="Талбай /м2/"/>
    <alias field="documented_area_m2" index="4" name="Бичиг баримтын талбай /м2/"/>
    <alias field="geo_id" index="1" name="Гео код"/>
    <alias field="landuse" index="2" name="Ашиглалтын зориулалт"/>
    <alias field="parcel_id" index="0" name="Нэгж талбарын дугаар"/>
    <alias field="valid_from" index="8" name="Эхлэх хугацаа"/>
    <alias field="valid_till" index="9" name="Дуусах хугаца"/>
  </aliases>
