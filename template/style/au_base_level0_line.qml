...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="geometry_type">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="level_status">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="170,53,82,255"/>
  ...
  <layerTransparency>9</layerTransparency>
  ...
  <aliases>
    ...
    <alias field="geometry_type" index="4" name=""/>
    <alias field="area_m2" index="5" name=""/>
    <alias field="valid_from" index="6" name=""/>
    <alias field="valid_till" index="7" name=""/>
    <alias field="geometry" index="8" name=""/>
    <alias field="length_m" index="9" name=""/>
    <alias field="point_geom" index="10" name=""/>
    <alias field="created_by" index="11" name=""/>
    <alias field="updated_by" index="12" name=""/>
    <alias field="created_at" index="13" name=""/>
    <alias field="updated_at" index="14" name=""/>
    <alias field="level_status" index="15" name=""/>
    <alias field="is_active" index="16" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1545140597">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="code"/>
      <column width="-1" hidden="0" type="field" name="name"/>
      <column width="273" hidden="0" type="field" name="description"/>
      <column width="-1" hidden="0" type="field" name="geometry_type"/>
      ...
      <column width="-1" hidden="0" type="field" name="level_status"/>
