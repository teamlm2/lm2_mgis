...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="old_address_khashaa" index="11" name=""/>
    <alias field="old_address_streetname" index="12" name=""/>
    <alias field="au2" index="13" name=""/>
    <alias field="property_no" index="14" name=""/>
    <alias field="org_type" index="15" name=""/>
    <alias field="parcel_base_id" index="16" name=""/>
  </aliases>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="old_address_khashaa" expression=""/>
    <default field="old_address_streetname" expression=""/>
    <default field="au2" expression=""/>
    <default field="property_no" expression=""/>
    <default field="org_type" expression=""/>
    <default field="parcel_base_id" expression=""/>
  </defaults>
