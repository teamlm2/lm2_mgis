...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="parcel_type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="1" label="Кадастрын үндсэн нэгж талбар"/>
      <category render="true" symbol="1" value="2" label="Кадастрын ажлын нэгж талбар"/>
      <category render="true" symbol="2" value="3" label="Газар зохион байгуулалтын төлөвлөгөө"/>
      <category render="true" symbol="3" value="7" label="Байр зүйн зургийн нэгж талбар"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="183,219,255,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="'Гудамж:' + address_streetname + '\n Тоот: ' + address_parcel_no"/>
    ...
    <property key="labeling/repeatDistance" value="3"/>
    ...
    <property key="labeling/yOffset" value="-0.3"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="630458512">
    <columns>
