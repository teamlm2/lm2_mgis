...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="substring">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
    ...
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="152,64,149,132"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="237,0,0,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="address_streetname"/>
    ...
    <property key="labeling/textColorB" value="204"/>
    <property key="labeling/textColorG" value="7"/>
    <property key="labeling/textColorR" value="129"/>
    <property key="labeling/textTransp" value="45"/>
  ...
  <aliases>
    ...
    <alias field="old_parcel_id" index="1" name="Хуучин нэгж талбарын дугаар"/>
