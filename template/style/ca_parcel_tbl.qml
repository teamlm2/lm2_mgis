...
<qgis version="2.16.3" simplifyAlgorithm="0" minimumScale="1e+08" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <aliases>
    ...
    <alias field="address_neighbourhood" index="8" name="Орон нутгийн нэршил"/>
    <alias field="address_streetname" index="7" name="Гудамжны нэр"/>
    ...
    <alias field="old_address_khashaa" index="11" name="Хашааны хуучин дугаар"/>
    <alias field="old_address_streetname" index="12" name="Гудамжны хуучин нэр"/>
