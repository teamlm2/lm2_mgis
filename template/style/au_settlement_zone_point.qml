...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias field="is_active" index="1" name=""/>
    <alias field="valid_from" index="2" name=""/>
    <alias field="valid_till" index="3" name=""/>
    <alias field="created_by" index="4" name=""/>
    <alias field="updated_by" index="5" name=""/>
    <alias field="created_at" index="6" name=""/>
    <alias field="updated_at" index="7" name=""/>
