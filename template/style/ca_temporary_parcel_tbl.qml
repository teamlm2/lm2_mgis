...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="child_landuse">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="child_landuse" index="3" name=""/>
    <alias field="area_m2" index="4" name=""/>
    <alias field="address_khashaa" index="5" name=""/>
    <alias field="address_streetname" index="6" name=""/>
    <alias field="address_neighbourhood" index="7" name=""/>
    <alias field="valid_from" index="8" name=""/>
    <alias field="valid_till" index="9" name=""/>
    <alias field="au2" index="10" name=""/>
    <alias field="org_type" index="11" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1093894024">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="child_landuse"/>
