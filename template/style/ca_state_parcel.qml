...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="land_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <displayfield>land_name</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="land_name" index="2" name=""/>
    <alias field="address_neighbourhood" index="3" name=""/>
    <alias field="area_m2" index="4" name=""/>
    <alias field="landuse" index="5" name=""/>
    <alias field="spa_law" index="6" name=""/>
    <alias field="valid_from" index="7" name=""/>
    <alias field="valid_till" index="8" name=""/>
    <alias field="au2" index="9" name=""/>
    <alias field="department_id" index="10" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="560695240">
    <columns>
      <column width="-1" hidden="0" type="field" name="id"/>
      <column width="-1" hidden="0" type="field" name="parcel_id"/>
      <column width="-1" hidden="0" type="field" name="land_name"/>
