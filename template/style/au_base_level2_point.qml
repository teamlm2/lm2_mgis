...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="au1_code">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="valid_from" index="5" name=""/>
    <alias field="valid_till" index="6" name=""/>
    <alias field="geometry_type" index="7" name=""/>
    <alias field="au1_code" index="8" name=""/>
    <alias field="geometry" index="9" name=""/>
    <alias field="length_m" index="10" name=""/>
    <alias field="line_geom" index="11" name=""/>
    <alias field="created_by" index="12" name=""/>
    <alias field="updated_by" index="13" name=""/>
    <alias field="created_at" index="14" name=""/>
    <alias field="updated_at" index="15" name=""/>
    <alias field="level_status" index="16" name=""/>
    <alias field="is_active" index="17" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="au1_code"/>
