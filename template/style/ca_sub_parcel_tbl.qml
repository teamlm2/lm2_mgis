...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="sub_parcel_id">
  ...
  <renderer-v2 attr="landuse" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="2601" label="2601"/>
      <category render="true" symbol="1" value="2602" label="2602"/>
      <category render="true" symbol="2" value="2603" label="2603"/>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="color" v="3,27,26,128"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="179,6,64,255"/>
  ...
  <displayfield>sub_parcel_id</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="sub_parcel_id" index="0" name=""/>
    <alias field="parcel_id" index="1" name=""/>
    <alias field="landuse" index="2" name=""/>
    <alias field="area_m2" index="3" name=""/>
    <alias field="valid_from" index="4" name=""/>
    <alias field="valid_till" index="5" name=""/>
    <alias field="au2" index="6" name=""/>
    <alias field="org_type" index="7" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="1093894024">
    <columns>
      <column width="-1" hidden="0" type="field" name="sub_parcel_id"/>
