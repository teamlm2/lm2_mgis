...
<qgis version="2.18.2" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    <edittype widgetv2type="TextEdit" name="parcel_feedback_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="plan_zone_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="landuse">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="project_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="plan_zone_type_id">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="is_citizen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    <alias field="parcel_feedback_id" index="0" name=""/>
    <alias field="plan_zone_id" index="1" name=""/>
    <alias field="landuse" index="2" name=""/>
    <alias field="project_id" index="3" name=""/>
    <alias field="point_geom" index="4" name=""/>
    <alias field="line_geom" index="5" name=""/>
    <alias field="area_m2" index="6" name=""/>
    <alias field="area_ha" index="7" name=""/>
    <alias field="description" index="8" name=""/>
    <alias field="valid_from" index="9" name=""/>
    <alias field="valid_till" index="10" name=""/>
    <alias field="badedturl" index="11" name=""/>
    <alias field="created_at" index="12" name=""/>
    <alias field="created_by" index="13" name=""/>
    <alias field="updated_at" index="14" name=""/>
    <alias field="updated_by" index="15" name=""/>
    <alias field="plan_zone_type_id" index="16" name=""/>
    <alias field="is_citizen" index="17" name=""/>
    <alias field="person_id" index="18" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="parcel_feedback_id"/>
      <column width="-1" hidden="0" type="field" name="plan_zone_id"/>
      <column width="-1" hidden="0" type="field" name="landuse"/>
      <column width="-1" hidden="0" type="field" name="project_id"/>
      ...
      <column width="-1" hidden="0" type="field" name="plan_zone_type_id"/>
      <column width="-1" hidden="0" type="field" name="is_citizen"/>
      <column width="-1" hidden="0" type="field" name="person_id"/>
