...
class Ui_ParcelInfoStatisticDialog(object):
    def setupUi(self, ParcelInfoStatisticDialog):
        ...
        self.result_user_twidget.setColumnCount(4)
        ...
        item = QtGui.QTableWidgetItem()
        self.result_user_twidget.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        self.result_user_twidget.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, ParcelInfoStatisticDialog):
        ...
        item.setText(_translate("ParcelInfoStatisticDialog", "Lastname", None))
        item = self.result_user_twidget.horizontalHeaderItem(2)
        item.setText(_translate("ParcelInfoStatisticDialog", "Firstname", None))
        item = self.result_user_twidget.horizontalHeaderItem(3)
