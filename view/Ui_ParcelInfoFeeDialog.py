...
class Ui_ParcelInfoFeeDialog(object):
    def setupUi(self, ParcelInfoFeeDialog):
        ...
        self.clear_button.setGeometry(QtCore.QRect(630, 16, 75, 23))
        ...
        self.paid_twidget = QtGui.QTableWidget(self.tab)
        self.paid_twidget.setGeometry(QtCore.QRect(5, 50, 845, 125))
