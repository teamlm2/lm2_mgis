...
class Ui_ParcelInfoFeeDialog(object):
    def setupUi(self, ParcelInfoFeeDialog):
        ...
        self.find_gbox.setGeometry(QtCore.QRect(5, 6, 844, 46))
        ...
        self.clear_button.setGeometry(QtCore.QRect(640, 22, 75, 23))
        ...
        self.object_cbox.setGeometry(QtCore.QRect(160, 190, 401, 22))
