...
class Ui_ParcelInfoFeeDialog(object):
    def setupUi(self, ParcelInfoFeeDialog):
        ...
        ParcelInfoFeeDialog.setMinimumSize(QtCore.QSize(867, 537))
        ParcelInfoFeeDialog.setMaximumSize(QtCore.QSize(880, 550))
        ParcelInfoFeeDialog.setBaseSize(QtCore.QSize(867, 537))
        self.close_button = QtGui.QPushButton(ParcelInfoFeeDialog)
        self.close_button.setGeometry(QtCore.QRect(789, 510, 75, 23))
        ...
        self.find_button.setGeometry(QtCore.QRect(680, 10, 75, 23))
        icon = QtGui.QIcon()
        ...
        self.old_parcel_id_edit.setGeometry(QtCore.QRect(290, 13, 131, 20))
        self.old_parcel_id_edit.setObjectName(_fromUtf8("old_parcel_id_edit"))
        self.label_3 = QtGui.QLabel(self.find_gbox)
        self.label_3.setGeometry(QtCore.QRect(10, 14, 57, 17))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_4 = QtGui.QLabel(self.find_gbox)
        self.label_4.setGeometry(QtCore.QRect(164, 15, 124, 17))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.label_5 = QtGui.QLabel(self.find_gbox)
        self.label_5.setEnabled(True)
        self.label_5.setGeometry(QtCore.QRect(424, 15, 113, 17))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.contract_no_edit = QtGui.QLineEdit(self.find_gbox)
        self.contract_no_edit.setEnabled(True)
        self.contract_no_edit.setGeometry(QtCore.QRect(540, 13, 131, 20))
        self.contract_no_edit.setObjectName(_fromUtf8("contract_no_edit"))
        self.person_id_edit = QtGui.QLineEdit(self.find_gbox)
        self.person_id_edit.setGeometry(QtCore.QRect(70, 13, 91, 20))
        self.person_id_edit.setObjectName(_fromUtf8("person_id_edit"))
        self.clear_button = QtGui.QPushButton(self.tab)
        self.clear_button.setGeometry(QtCore.QRect(770, 10, 75, 23))
        ...
        self.label_26.setGeometry(QtCore.QRect(10, 15, 126, 17))
        ...
        self.label_27.setGeometry(QtCore.QRect(10, 60, 114, 17))
        ...
        self.label_29.setGeometry(QtCore.QRect(10, 150, 165, 17))
        ...
        self.label_30.setGeometry(QtCore.QRect(150, 60, 122, 17))
        ...
        self.label_31.setGeometry(QtCore.QRect(150, 15, 93, 17))
        ...
        self.label_40.setGeometry(QtCore.QRect(10, 15, 125, 17))
        ...
        self.label_41.setGeometry(QtCore.QRect(10, 60, 168, 17))
        ...
        self.label_44.setGeometry(QtCore.QRect(150, 60, 138, 17))
        ...
        self.label_45.setGeometry(QtCore.QRect(150, 15, 114, 17))
        self.label_45.setObjectName(_fromUtf8("label_45"))
        self.label_46 = QtGui.QLabel(self.groupBox_5)
        self.label_46.setGeometry(QtCore.QRect(150, 150, 83, 17))
        ...
        self.label_47.setGeometry(QtCore.QRect(10, 16, 108, 17))
        ...
        self.label_22.setGeometry(QtCore.QRect(10, 150, 54, 17))
        ...
        self.label_48.setGeometry(QtCore.QRect(10, 60, 70, 17))
        ...
        self.label_49.setGeometry(QtCore.QRect(10, 106, 84, 17))
        self.label_49.setObjectName(_fromUtf8("label_49"))
        self.label_50 = QtGui.QLabel(self.groupBox)
        self.label_50.setGeometry(QtCore.QRect(150, 16, 129, 17))
        ...
        self.payment_twidget.setColumnCount(15)
        ...
        item = QtGui.QTableWidgetItem()
        self.payment_twidget.setHorizontalHeaderItem(13, item)
        item = QtGui.QTableWidgetItem()
        self.payment_twidget.setHorizontalHeaderItem(14, item)
        ...
        self.object_cbox.setGeometry(QtCore.QRect(430, 43, 401, 22))
        self.object_cbox.setObjectName(_fromUtf8("object_cbox"))
        self.year_cbox = QtGui.QComboBox(self.tab)
        self.year_cbox.setGeometry(QtCore.QRect(296, 43, 129, 22))
        self.year_cbox.setObjectName(_fromUtf8("year_cbox"))
        self.city_type_cbox = QtGui.QComboBox(self.tab)
        self.city_type_cbox.setGeometry(QtCore.QRect(168, 43, 123, 22))
        self.city_type_cbox.setObjectName(_fromUtf8("city_type_cbox"))
        self.all_status_chbox = QtGui.QCheckBox(self.tab)
        self.all_status_chbox.setGeometry(QtCore.QRect(10, 43, 151, 21))
        self.all_status_chbox.setObjectName(_fromUtf8("all_status_chbox"))
        self.tabWidget.addTab(self.tab, _fromUtf8(""))
        self.save_button = QtGui.QPushButton(ParcelInfoFeeDialog)
        self.save_button.setGeometry(QtCore.QRect(704, 510, 75, 23))
        self.save_button.setObjectName(_fromUtf8("save_button"))
        self.finish_button = QtGui.QPushButton(ParcelInfoFeeDialog)
        self.finish_button.setGeometry(QtCore.QRect(620, 510, 75, 23))
        self.finish_button.setObjectName(_fromUtf8("finish_button"))
        self.one_select_chbox = QtGui.QCheckBox(ParcelInfoFeeDialog)
        self.one_select_chbox.setGeometry(QtCore.QRect(320, 510, 211, 20))
        ...
        self.status_label.setGeometry(QtCore.QRect(10, 510, 311, 20))
        self.status_label.setText(_fromUtf8(""))
        self.status_label.setObjectName(_fromUtf8("status_label"))
        self.delete_button = QtGui.QPushButton(ParcelInfoFeeDialog)
        self.delete_button.setGeometry(QtCore.QRect(530, 510, 75, 23))
        ...
        ParcelInfoFeeDialog.setTabOrder(self.person_id_edit, self.one_select_chbox)
        ParcelInfoFeeDialog.setTabOrder(self.one_select_chbox, self.delete_button)
        ParcelInfoFeeDialog.setTabOrder(self.delete_button, self.tabWidget)
        ParcelInfoFeeDialog.setTabOrder(self.tabWidget, self.payment_total_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_total_sbox, self.finish_button)
        ParcelInfoFeeDialog.setTabOrder(self.finish_button, self.save_button)
        ParcelInfoFeeDialog.setTabOrder(self.save_button, self.clear_button)
        ParcelInfoFeeDialog.setTabOrder(self.clear_button, self.contract_no_edit)
        ParcelInfoFeeDialog.setTabOrder(self.contract_no_edit, self.payment_contract_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_contract_sbox, self.payment_before_less_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_before_less_sbox, self.payment_before_over_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_before_over_sbox, self.payment_year_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_year_sbox, self.payment_fund_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_fund_sbox, self.payment_loss_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.payment_loss_sbox, self.paid_less_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_less_sbox, self.paid_before_less_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_before_less_sbox, self.paid_year_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_year_sbox, self.paid_fund_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_fund_sbox, self.paid_district_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_district_sbox, self.paid_city_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_city_sbox, self.paid_invalid_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_invalid_sbox, self.paid_over_sbox)
        ParcelInfoFeeDialog.setTabOrder(self.paid_over_sbox, self.payment_contract_edit)
        ParcelInfoFeeDialog.setTabOrder(self.payment_contract_edit, self.decsription_txt)
        ParcelInfoFeeDialog.setTabOrder(self.decsription_txt, self.payment_zoriulalt_edit)
        ParcelInfoFeeDialog.setTabOrder(self.payment_zoriulalt_edit, self.payment_name_edit)
        ParcelInfoFeeDialog.setTabOrder(self.payment_name_edit, self.payment_area_edit)
        ParcelInfoFeeDialog.setTabOrder(self.payment_area_edit, self.tabWidget_2)
        ParcelInfoFeeDialog.setTabOrder(self.tabWidget_2, self.payment_twidget)
        ParcelInfoFeeDialog.setTabOrder(self.payment_twidget, self.paid_twidget)
        ParcelInfoFeeDialog.setTabOrder(self.paid_twidget, self.object_cbox)
        ParcelInfoFeeDialog.setTabOrder(self.object_cbox, self.year_cbox)
        ParcelInfoFeeDialog.setTabOrder(self.year_cbox, self.city_type_cbox)
        ParcelInfoFeeDialog.setTabOrder(self.city_type_cbox, self.close_button)

    def retranslateUi(self, ParcelInfoFeeDialog):
        ParcelInfoFeeDialog.setWindowTitle(_translate("ParcelInfoFeeDialog", "Dialog", None))
        self.close_button.setText(_translate("ParcelInfoFeeDialog", "Хаах", None))
        ...
        self.label_3.setText(_translate("ParcelInfoFeeDialog", "Регистр:", None))
        self.label_4.setText(_translate("ParcelInfoFeeDialog", "Хуучин НТ Дугаар:", None))
        self.label_5.setText(_translate("ParcelInfoFeeDialog", "Гэрээний дугаар:", None))
        ...
        item.setText(_translate("ParcelInfoFeeDialog", "Төлөв", None))
        ...
        item.setText(_translate("ParcelInfoFeeDialog", "НТ-н дугаар", None))
        ...
        item = self.payment_twidget.horizontalHeaderItem(13)
        item.setText(_translate("ParcelInfoFeeDialog", "Хүчингүйд тооцсон дүн", None))
        item = self.payment_twidget.horizontalHeaderItem(14)
        ...
        self.all_status_chbox.setText(_translate("ParcelInfoFeeDialog", "Бүх төлөв", None))
