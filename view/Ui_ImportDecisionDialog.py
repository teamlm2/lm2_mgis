...
class Ui_ImportDecisionDialog(object):
    def setupUi(self, ImportDecisionDialog):
        ...
        self.decision_tab_widget.setObjectName(_fromUtf8("decision_tab_widget"))
    ...
    def retranslateUi(self, ImportDecisionDialog):
        ...
        self.decision_tab_widget.setTabText(self.decision_tab_widget.indexOf(self.import_dec_tab), _translate("ImportDecisionDialog", "Import", None))
        ...
        self.decision_tab_widget.setTabText(self.decision_tab_widget.indexOf(self.join_app_tab), _translate("ImportDecisionDialog", "Join application", None))
