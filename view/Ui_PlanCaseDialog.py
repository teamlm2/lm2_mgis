...
class Ui_PlanCaseDialog(object):
    def setupUi(self, PlanCaseDialog):
        ...
        self.landuse_type_cbox = QtGui.QComboBox(self.tab_3)
        self.landuse_type_cbox.setGeometry(QtCore.QRect(429, 5, 331, 22))
        self.landuse_type_cbox.setObjectName(_fromUtf8("landuse_type_cbox"))
        ...
        self.cadastre_form_change_button.setGeometry(QtCore.QRect(687, 232, 75, 23))
        self.cadastre_form_change_button.setObjectName(_fromUtf8("cadastre_form_change_button"))
        self.add_button_2 = QtGui.QPushButton(self.tab_3)
        self.add_button_2.setGeometry(QtCore.QRect(10, 230, 30, 25))
        self.add_button_2.setText(_fromUtf8(""))
        self.add_button_2.setIcon(icon1)
        self.add_button_2.setObjectName(_fromUtf8("add_button_2"))
        self.cadastre_change_form_check_box = QtGui.QCheckBox(self.tab_3)
        self.cadastre_change_form_check_box.setGeometry(QtCore.QRect(91, 234, 110, 17))
        self.cadastre_change_form_check_box.setObjectName(_fromUtf8("cadastre_change_form_check_box"))
        self.cadastre_current_tree_widget = QtGui.QTreeWidget(self.tab_3)
        self.cadastre_current_tree_widget.setGeometry(QtCore.QRect(10, 260, 751, 135))
        self.cadastre_current_tree_widget.setWordWrap(True)
        self.cadastre_current_tree_widget.setObjectName(_fromUtf8("cadastre_current_tree_widget"))
        self.cadastre_current_tree_widget.header().setDefaultSectionSize(200)
        self.cadastre_form_type_change_cbox = QtGui.QComboBox(self.tab_3)
        self.cadastre_form_type_change_cbox.setEnabled(False)
        self.cadastre_form_type_change_cbox.setGeometry(QtCore.QRect(206, 232, 261, 22))
        self.cadastre_form_type_change_cbox.setObjectName(_fromUtf8("cadastre_form_type_change_cbox"))
        self.remove_button_2 = QtGui.QPushButton(self.tab_3)
        self.remove_button_2.setGeometry(QtCore.QRect(50, 230, 30, 25))
        self.remove_button_2.setText(_fromUtf8(""))
        self.remove_button_2.setIcon(icon2)
        self.remove_button_2.setObjectName(_fromUtf8("remove_button_2"))
        self.cadastre_tree_widget = QtGui.QTreeWidget(self.tab_3)
        self.cadastre_tree_widget.setGeometry(QtCore.QRect(10, 90, 751, 135))
        self.cadastre_tree_widget.setWordWrap(True)
        self.cadastre_tree_widget.setObjectName(_fromUtf8("cadastre_tree_widget"))
        self.find_button_2 = QtGui.QPushButton(self.tab_3)
        self.find_button_2.setGeometry(QtCore.QRect(687, 58, 75, 23))
        self.find_button_2.setObjectName(_fromUtf8("find_button_2"))
        self.cadastre_right_type_change_cbox = QtGui.QComboBox(self.tab_3)
        self.cadastre_right_type_change_cbox.setEnabled(False)
        self.cadastre_right_type_change_cbox.setGeometry(QtCore.QRect(480, 232, 200, 22))
    ...
    def retranslateUi(self, PlanCaseDialog):
        ...
        self.cadastre_current_tree_widget.setSortingEnabled(True)
        self.cadastre_current_tree_widget.headerItem().setText(0, _translate("PlanCaseDialog", "Parcel Info", None))
        self.cadastre_current_tree_widget.headerItem().setText(1, _translate("PlanCaseDialog", "Form type", None))
        self.cadastre_current_tree_widget.headerItem().setText(2, _translate("PlanCaseDialog", "From", None))
        self.cadastre_tree_widget.setSortingEnabled(True)
        self.cadastre_tree_widget.headerItem().setText(0, _translate("PlanCaseDialog", "Result", None))
        self.find_button_2.setText(_translate("PlanCaseDialog", "Find", None))
