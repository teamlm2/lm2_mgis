...
class Ui_PlanCaseDialog(object):
    def setupUi(self, PlanCaseDialog):
        ...
        self.cadastre_right_type_change_cbox_2 = QtGui.QComboBox(self.import_groupbox)
        self.cadastre_right_type_change_cbox_2.setEnabled(False)
        self.cadastre_right_type_change_cbox_2.setGeometry(QtCore.QRect(10, 80, 361, 22))
    ...
    def retranslateUi(self, PlanCaseDialog):
        ...
        self.label_7.setText(_translate("PlanCaseDialog", "Арга хэмжээний төрөл", None))
