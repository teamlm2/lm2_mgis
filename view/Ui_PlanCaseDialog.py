...
class Ui_PlanCaseDialog(object):
    def setupUi(self, PlanCaseDialog):
        ...
        self.monitoring_twidget.setColumnCount(0)
        self.monitoring_twidget.setRowCount(0)
        self.cad_remove_button_2 = QtGui.QPushButton(self.tab_4)
        self.cad_remove_button_2.setGeometry(QtCore.QRect(49, 174, 30, 25))
        self.cad_remove_button_2.setText(_fromUtf8(""))
        self.cad_remove_button_2.setIcon(icon3)
        self.cad_remove_button_2.setObjectName(_fromUtf8("cad_remove_button_2"))
        self.cad_add_button_2 = QtGui.QPushButton(self.tab_4)
        self.cad_add_button_2.setGeometry(QtCore.QRect(9, 174, 30, 25))
        self.cad_add_button_2.setText(_fromUtf8(""))
        self.cad_add_button_2.setIcon(icon2)
        self.cad_add_button_2.setObjectName(_fromUtf8("cad_add_button_2"))
        self.cadastre_right_type_change_cbox_2 = QtGui.QComboBox(self.tab_4)
        self.cadastre_right_type_change_cbox_2.setEnabled(False)
        self.cadastre_right_type_change_cbox_2.setGeometry(QtCore.QRect(479, 176, 200, 22))
        self.cadastre_right_type_change_cbox_2.setObjectName(_fromUtf8("cadastre_right_type_change_cbox_2"))
        self.cadastre_form_type_change_cbox_2 = QtGui.QComboBox(self.tab_4)
        self.cadastre_form_type_change_cbox_2.setEnabled(False)
        self.cadastre_form_type_change_cbox_2.setGeometry(QtCore.QRect(205, 176, 261, 22))
        self.cadastre_form_type_change_cbox_2.setObjectName(_fromUtf8("cadastre_form_type_change_cbox_2"))
        self.cadastre_change_form_check_box_2 = QtGui.QCheckBox(self.tab_4)
        self.cadastre_change_form_check_box_2.setGeometry(QtCore.QRect(90, 178, 110, 17))
        self.cadastre_change_form_check_box_2.setObjectName(_fromUtf8("cadastre_change_form_check_box_2"))
        self.cad_process_type_cbox_2 = QtGui.QComboBox(self.tab_4)
        self.cad_process_type_cbox_2.setEnabled(True)
        self.cad_process_type_cbox_2.setGeometry(QtCore.QRect(205, 201, 474, 22))
        self.cad_process_type_cbox_2.setObjectName(_fromUtf8("cad_process_type_cbox_2"))
        self.cadastre_form_change_button_2 = QtGui.QPushButton(self.tab_4)
        self.cadastre_form_change_button_2.setEnabled(False)
        self.cadastre_form_change_button_2.setGeometry(QtCore.QRect(685, 200, 75, 23))
        self.cadastre_form_change_button_2.setObjectName(_fromUtf8("cadastre_form_change_button_2"))
        self.cadastre_current_twidget_2 = QtGui.QTableWidget(self.tab_4)
        self.cadastre_current_twidget_2.setGeometry(QtCore.QRect(10, 230, 751, 140))
        self.cadastre_current_twidget_2.setObjectName(_fromUtf8("cadastre_current_twidget_2"))
        self.cadastre_current_twidget_2.setColumnCount(4)
        ...
        item = QtGui.QTableWidgetItem()
        self.cadastre_current_twidget_2.setHorizontalHeaderItem(3, item)
        self.cadastre_current_twidget_2.horizontalHeader().setDefaultSectionSize(200)
        ...
        self.land_use_type_cbox_2.setGeometry(QtCore.QRect(429, 3, 251, 22))
        self.land_use_type_cbox_2.setObjectName(_fromUtf8("land_use_type_cbox_2"))
        self.label_15 = QtGui.QLabel(self.tab_4)
        self.label_15.setGeometry(QtCore.QRect(7, 6, 80, 16))
        self.label_15.setObjectName(_fromUtf8("label_15"))
        self.label_16 = QtGui.QLabel(self.tab_4)
        self.label_16.setGeometry(QtCore.QRect(350, 6, 80, 16))
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.cadastre_right_type_cbox_2 = QtGui.QComboBox(self.tab_4)
        self.cadastre_right_type_cbox_2.setGeometry(QtCore.QRect(90, 3, 251, 22))
    ...
    def retranslateUi(self, PlanCaseDialog):
        ...
        self.cadastre_change_form_check_box_2.setText(_translate("PlanCaseDialog", "Change right form", None))
        self.cadastre_form_change_button_2.setText(_translate("PlanCaseDialog", "Change", None))
        ...
        item.setText(_translate("PlanCaseDialog", "Form Type", None))
        item = self.cadastre_current_twidget_2.horizontalHeaderItem(3)
        item.setText(_translate("PlanCaseDialog", "Right Type", None))
