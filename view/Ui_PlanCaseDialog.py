...
class Ui_PlanCaseDialog(object):
    def setupUi(self, PlanCaseDialog):
        ...
        PlanCaseDialog.resize(785, 555)
        self.groupBox = QtGui.QGroupBox(PlanCaseDialog)
        self.groupBox.setGeometry(QtCore.QRect(5, 10, 774, 61))
        ...
        self.remove_button.setGeometry(QtCore.QRect(370, 210, 30, 25))
        ...
        self.label_11.setGeometry(QtCore.QRect(7, 8, 101, 16))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.plan_cbox = QtGui.QComboBox(self.tab_2)
        self.plan_cbox.setGeometry(QtCore.QRect(111, 5, 271, 22))
        self.plan_cbox.setObjectName(_fromUtf8("plan_cbox"))
        self.selected_layer_button = QtGui.QPushButton(self.tab_2)
        self.selected_layer_button.setGeometry(QtCore.QRect(540, 5, 75, 23))
        self.selected_layer_button.setObjectName(_fromUtf8("selected_layer_button"))
        self.find_button = QtGui.QPushButton(self.tab_2)
        self.find_button.setGeometry(QtCore.QRect(540, 58, 75, 23))
    ...
    def retranslateUi(self, PlanCaseDialog):
        ...
        self.current_tree_widget.headerItem().setText(0, _translate("PlanCaseDialog", "Result", None))
        self.label_11.setText(_translate("PlanCaseDialog", "Plan", None))
        self.selected_layer_button.setText(_translate("PlanCaseDialog", "Layer Load", None))
