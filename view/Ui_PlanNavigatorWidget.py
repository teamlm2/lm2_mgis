...
class Ui_PlanNavigatorWidget(object):
    def setupUi(self, PlanNavigatorWidget):
        ...
        self.groupBox_2 = QtGui.QGroupBox(self.st_tm_filter_tab)
        self.groupBox_2.setGeometry(QtCore.QRect(6, 236, 371, 271))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
...
"}"))
        ...
        self.layer_view_button = QtGui.QPushButton(self.groupBox_2)
        self.layer_view_button.setGeometry(QtCore.QRect(190, 170, 161, 23))
        self.layer_view_button.setStyleSheet(_fromUtf8(""))
        ...
        self.fee_tax_zone_button.setGeometry(QtCore.QRect(16, 90, 161, 23))
        ...
        self.mpa_zone_button.setGeometry(QtCore.QRect(190, 40, 161, 23))
        self.mpa_zone_button.setObjectName(_fromUtf8("mpa_zone_button"))
        self.sec_zone_button = QtGui.QPushButton(self.groupBox_2)
        self.sec_zone_button.setGeometry(QtCore.QRect(190, 65, 161, 23))
        ...
        self.free_zone_button.setGeometry(QtCore.QRect(190, 15, 161, 23))
        ...
        self.valuation_zone_button.setGeometry(QtCore.QRect(190, 90, 161, 23))
        self.valuation_zone_button.setObjectName(_fromUtf8("valuation_zone_button"))
        self.type_cbox = QtGui.QComboBox(self.groupBox_2)
        self.type_cbox.setGeometry(QtCore.QRect(17, 135, 333, 22))
        self.type_cbox.setObjectName(_fromUtf8("type_cbox"))
        self.label = QtGui.QLabel(self.groupBox_2)
        self.label.setGeometry(QtCore.QRect(19, 120, 331, 16))
        ...
        self.current_view_button.setGeometry(QtCore.QRect(275, 270, 75, 23))
...
"font: 75 14pt \"Helvetica\";"))
    ...
    def retranslateUi(self, PlanNavigatorWidget):
        ...
        self.label.setText(_translate("PlanNavigatorWidget", "Type", None))
