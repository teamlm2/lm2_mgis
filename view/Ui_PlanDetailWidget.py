...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.main_zone_load_button.setGeometry(QtCore.QRect(9, 4, 75, 23))
        self.main_zone_load_button.setObjectName(_fromUtf8("main_zone_load_button"))
        self.main_tree_widget = QtGui.QTreeWidget(self.tab)
        self.main_tree_widget.setGeometry(QtCore.QRect(10, 30, 361, 361))
        ...
        self.sub_tree_widget.setGeometry(QtCore.QRect(10, 30, 361, 361))
        ...
        self.sub_zone_load_button = QtGui.QPushButton(self.tab_2)
        self.sub_zone_load_button.setGeometry(QtCore.QRect(9, 4, 75, 23))
        ...
        self.parcel_tree_widget.setGeometry(QtCore.QRect(10, 30, 361, 361))
        ...
        self.parcel_zone_load_button = QtGui.QPushButton(self.tab_3)
        self.parcel_zone_load_button.setGeometry(QtCore.QRect(9, 4, 75, 23))
        self.parcel_zone_load_button.setObjectName(_fromUtf8("parcel_zone_load_button"))
    ...
    def retranslateUi(self, PlanDetailWidget):
        ...
        self.parcel_zone_load_button.setText(_translate("PlanDetailWidget", "Load", None))
