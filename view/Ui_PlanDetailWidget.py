...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.groupBox.setGeometry(QtCore.QRect(4, 27, 572, 201))
        ...
        self.main_edit_attribute_button.setGeometry(QtCore.QRect(7, 170, 81, 23))
        ...
        self.main_zone_load_button.setGeometry(QtCore.QRect(484, 170, 81, 23))
        self.main_zone_load_button.setObjectName(_fromUtf8("main_zone_load_button"))
        self.get_selected_features_button = QtGui.QPushButton(self.groupBox)
        self.get_selected_features_button.setGeometry(QtCore.QRect(101, 170, 115, 23))
        self.get_selected_features_button.setObjectName(_fromUtf8("get_selected_features_button"))
        self.parcel_clear_button = QtGui.QPushButton(self.groupBox)
        self.parcel_clear_button.setGeometry(QtCore.QRect(400, 170, 75, 23))
        self.parcel_clear_button.setObjectName(_fromUtf8("parcel_clear_button"))
        self.delete_parcel_button = QtGui.QPushButton(self.groupBox)
        self.delete_parcel_button.setGeometry(QtCore.QRect(230, 170, 75, 23))
        ...
        self.main_tree_widget.setGeometry(QtCore.QRect(4, 260, 573, 485))
        self.main_tree_widget.setObjectName(_fromUtf8("main_tree_widget"))
        self.parcel_results_label = QtGui.QLabel(self.scrollAreaWidgetContents)
        self.parcel_results_label.setGeometry(QtCore.QRect(10, 230, 181, 20))
        font = QtGui.QFont()
        ...
        self.main_load_pbar = QtGui.QProgressBar(self.scrollAreaWidgetContents)
        self.main_load_pbar.setGeometry(QtCore.QRect(310, 230, 261, 23))
    ...
    def retranslateUi(self, PlanDetailWidget):
        ...
        self.get_selected_features_button.setText(_translate("PlanDetailWidget", "Get Selected Features", None))
        self.parcel_clear_button.setText(_translate("PlanDetailWidget", "Clear", None))
        self.delete_parcel_button.setText(_translate("PlanDetailWidget", "Delete", None))
        ...
        self.parcel_results_label.setText(_translate("PlanDetailWidget", "Results:", None))
