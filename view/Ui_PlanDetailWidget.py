...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.get_data_layer_button = QtGui.QPushButton(self.groupBox)
        self.get_data_layer_button.setGeometry(QtCore.QRect(100, 170, 81, 23))
        self.get_data_layer_button.setObjectName(_fromUtf8("get_data_layer_button"))
        ...
        self.delete_parcel_button.setGeometry(QtCore.QRect(192, 170, 75, 23))
    ...
    def retranslateUi(self, PlanDetailWidget):
        ...
        self.get_data_layer_button.setText(_translate("PlanDetailWidget", "Get Data layer", None))
