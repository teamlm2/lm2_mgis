...
class Ui_SpaParcelWidget(object):
    def setupUi(self, SpaParcelWidget):
        ...
        self.parcel_id_edit = QtGui.QLineEdit(self.groupBox_18)
        self.parcel_id_edit.setGeometry(QtCore.QRect(190, 29, 170, 20))
        ...
        self.app_date_edit = QtGui.QDateEdit(self.groupBox_18)
        self.app_date_edit.setEnabled(False)
        self.app_date_edit.setGeometry(QtCore.QRect(190, 215, 91, 21))
        self.app_date_edit.setCalendarPopup(True)
        self.app_date_edit.setObjectName(_fromUtf8("app_date_edit"))
        self.clear_button = QtGui.QPushButton(self.groupBox_18)
        self.clear_button.setGeometry(QtCore.QRect(210, 245, 75, 23))
        ...
        self.app_date_cbox = QtGui.QCheckBox(self.groupBox_18)
        self.app_date_cbox.setGeometry(QtCore.QRect(12, 216, 171, 20))
        self.app_date_cbox.setObjectName(_fromUtf8("app_date_cbox"))
        self.results_label = QtGui.QLabel(self.groupBox_18)
        self.results_label.setGeometry(QtCore.QRect(10, 247, 121, 20))
        font = QtGui.QFont()
        ...
        self.results_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.spa_type_cbox = QtGui.QComboBox(self.groupBox_18)
        self.spa_type_cbox.setGeometry(QtCore.QRect(10, 28, 171, 22))
...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.pasture_app_add_button.setGeometry(QtCore.QRect(260, 6, 111, 23))
    ...
    def retranslateUi(self, SpaParcelWidget):
        ...
        self.app_date_edit.setDisplayFormat(_translate("SpaParcelWidget", "yyyy-MM-dd", None))
        self.clear_button.setText(_translate("SpaParcelWidget", "Clear", None))
        self.pasture_find_button.setText(_translate("SpaParcelWidget", "Find", None))
        self.app_date_cbox.setText(_translate("SpaParcelWidget", "Application Date", None))
        self.results_label.setText(_translate("SpaParcelWidget", "Results:", None))
