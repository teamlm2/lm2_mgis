...
class Ui_PastureWidget(object):
    def setupUi(self, PastureWidget):
        ...
        self.main_tab_widget = QtGui.QTabWidget(self.scrollAreaWidgetContents)
        self.main_tab_widget.setGeometry(QtCore.QRect(10, 60, 386, 600))
        self.main_tab_widget.setMaximumSize(QtCore.QSize(16777215, 600))
        self.main_tab_widget.setUsesScrollButtons(True)
        self.main_tab_widget.setObjectName(_fromUtf8("main_tab_widget"))
        self.monitoring_tab = QtGui.QWidget()
        self.monitoring_tab.setObjectName(_fromUtf8("monitoring_tab"))
        self.monitoring_load_button = QtGui.QPushButton(self.monitoring_tab)
        ...
        self.tabWidget_2 = QtGui.QTabWidget(self.monitoring_tab)
...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.point_detail_button = QtGui.QPushButton(self.monitoring_tab)
        ...
        self.main_tab_widget.addTab(self.monitoring_tab, _fromUtf8(""))
        self.app_tab = QtGui.QWidget()
        self.app_tab.setObjectName(_fromUtf8("app_tab"))
        self.groupBox_18 = QtGui.QGroupBox(self.app_tab)
        ...
        self.groupBox_19 = QtGui.QGroupBox(self.app_tab)
...
"font: 75 14pt \"Helvetica\";"))
        ...
        self.pug_register_button = QtGui.QPushButton(self.app_tab)
        ...
        self.pasture_app_add_button = QtGui.QPushButton(self.app_tab)
        ...
        self.draft_decision_button = QtGui.QPushButton(self.app_tab)
        ...
        PastureWidget.setTabOrder(self.working_l2_cbox, self.main_tab_widget)
        PastureWidget.setTabOrder(self.main_tab_widget, self.scrollArea)
    ...
    def retranslateUi(self, PastureWidget):
        ...
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.monitoring_tab), _translate("PastureWidget", "Monitoring", None))
        ...
        self.label_68.setText(_translate("PastureWidget", "Person Group", None))
        ...
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.app_tab), _translate("PastureWidget", "Pasture(PUA)", None))
        self.settings_button.setText(_translate("PastureWidget", "Settings Load", None))
        self.main_tab_widget.setTabText(self.main_tab_widget.indexOf(self.settings_tab), _translate("PastureWidget", "Settings", None))
