...
class Ui_PlanLayerFilterDialog(object):
    def setupUi(self, PlanLayerFilterDialog):
        ...
        PlanLayerFilterDialog.resize(402, 666)
        self.groupBox = QtGui.QGroupBox(PlanLayerFilterDialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 12, 381, 261))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.admin_unit_treewidget = QtGui.QTreeWidget(self.groupBox)
        self.admin_unit_treewidget.setGeometry(QtCore.QRect(10, 20, 361, 231))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 270, 381, 351))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.process_type_treewidget = QtGui.QTreeWidget(self.groupBox_2)
        self.process_type_treewidget.setGeometry(QtCore.QRect(10, 20, 361, 321))
        ...
        self.pushButton.setGeometry(QtCore.QRect(236, 630, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.close_button = QtGui.QPushButton(PlanLayerFilterDialog)
        self.close_button.setGeometry(QtCore.QRect(320, 630, 75, 23))
        self.close_button.setObjectName(_fromUtf8("close_button"))
        self.help_button = QtGui.QPushButton(PlanLayerFilterDialog)
        self.help_button.setGeometry(QtCore.QRect(150, 630, 75, 23))
