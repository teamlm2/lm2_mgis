CREATE OR REPLACE FUNCTION base.calculate_dem_cama_parcel(dem_type integer, parcel_id text)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION base.calculate_dem_cama_parcel(integer, text)
  OWNER TO geodb_admin;



select base.calculate_dem_cama_parcel(1, '1800900001');
