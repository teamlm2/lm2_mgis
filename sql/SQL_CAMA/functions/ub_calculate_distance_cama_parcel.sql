DROP FUNCTION base.ub_calculate_distance_cama_parcel(integer, text);

CREATE OR REPLACE FUNCTION base.ub_calculate_distance_cama_parcel(
...
BEGIN
	...
	FROM data_ub.ca_ub_parcel_tbl a, data_cama.cm_parcel_tbl b 
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION base.ub_calculate_distance_cama_parcel(integer, text)
  OWNER TO geodb_admin;
--------------


select base.ub_calculate_distance_cama_parcel(320301, '1160800002');