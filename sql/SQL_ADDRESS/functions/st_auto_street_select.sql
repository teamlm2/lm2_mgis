...
-- DROP FUNCTION base.st_auto_street_select(integer, integer, integer);
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION base.st_auto_street_select(integer, integer, bigint)
  OWNER TO geodb_admin;
GRANT EXECUTE ON FUNCTION base.st_auto_street_select(integer, integer, bigint) TO public;
