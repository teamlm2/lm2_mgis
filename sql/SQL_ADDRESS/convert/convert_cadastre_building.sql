insert into data_address.ca_building_address(building_id, is_active, in_source, zipcode_id, street_id, address_building_no, address_parcel_no au1, au2, created_at, valid_from, valid_till, geometry)
...
where aa.au2 = '08110' and cba.au2 = '08110'
