-- View: data_landuse.ca_landuse_type
...
CREATE OR REPLACE VIEW data_landuse.ca_landuse_type AS 
 SELECT ca_landuse_type_tbl.parcel_id,
  ...
  WHERE ca_landuse_type_tbl.is_active = true and ca_landuse_type_tbl.au2::text = (( SELECT set_role_user.working_au_level2::text AS au2
