...
class PastureContractDocumentDelegate(QStyledItemDelegate):

    def __init__(self, widget, parent):

        super(PastureContractDocumentDelegate, self).__init__(parent)
        self.widget = widget
        self.parent = parent
    ...
    def paint(self, painter, option, index):
        ...
        if index.column() == OPEN_FILE_COLUMN:
            ...
            super(PastureContractDocumentDelegate, self).paint(painter, option, index)
            return
            ...
            if index.isValid()\
                ...
                if index.column() == OPEN_FILE_COLUMN:
                    ...
                    if file_dialog.exec_():
                        ...
                        default_path = PasturePath.contrac_file_path()
                        ...
                        try:
                            ...
                            if host == "localhost":
                                default_path = default_path +'/'+ contract_no
                    ...
                    try:
                        ...
                        if file_name != '':
                            shutil.copy2(default_path + '/'+file_name, PasturePath.view_file_path())
                            QDesktopServices.openUrl(QUrl.fromLocalFile(PasturePath.view_file_path()))
